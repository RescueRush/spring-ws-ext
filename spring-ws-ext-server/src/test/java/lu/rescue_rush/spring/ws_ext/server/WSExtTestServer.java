...
@SpringBootTest(classes = WSExtMainServer.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class WSExtTestServer {

	@Autowired
	private WSExtMainServer wsExtMain;
