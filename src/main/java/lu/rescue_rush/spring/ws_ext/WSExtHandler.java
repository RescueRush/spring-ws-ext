...
import lu.rescue_rush.spring.ws_ext.WebSocketHandlerExt.ScheduledTaskData;
import lu.rescue_rush.spring.ws_ext.WebSocketHandlerExt.WebSocketSessionData;

public abstract class WSExtHandler {

	private WebSocketHandlerExt webSocketHandler;
	...
	public WebSocketHandlerExt getWebSocketHandler() {
		return webSocketHandler;
	}

	public void setWebSocketHandler(WebSocketHandlerExt webSocketHandler) {
